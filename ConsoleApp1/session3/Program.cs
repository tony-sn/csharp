...
// process
var formatPrice = Convert.ToInt32(price);
var formatDiscount = Convert.ToInt32(discount);
...
var formatNumber = Convert.ToInt32(number);
...
var formatGpa = Convert.ToDouble(gpa);
if (formatGpa >= 9)
...
var lookingNum = Console.ReadLine();

// Check if the input is not null
if (lookingNum != null)
{
    // Attempt to convert the string to an integer
    if (int.TryParse(lookingNum, out var ln))
    {
