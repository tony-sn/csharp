...
var formatNd = Convert.ToInt32(nd);
var weeks = formatNd / 7;
var days = formatNd % 7;

var weekLabel = weeks == 1 ? "week" : "weeks";
...
var formatPrice = Convert.ToDouble(price);
var formatDiscount = Convert.ToDouble(discount);
...
// PROCESS
// format user input
var totalMinutes = Convert.ToInt32(min);
...
var formatVat = Convert.ToDouble(vat);
var formatFee = Convert.ToDouble(fee);
...
// PROCESS
// enter USD amount
var formatUSD = Convert.ToInt32(usd);
// enter rate
var formatRate = Convert.ToDouble(rate);
// vnd = usd * rate
...
if (!int.TryParse(Console.ReadLine(), out var balance))
{
...
if (!double.TryParse(Console.ReadLine(), out var timeTravelled) || timeTravelled < 0)
{
    Console.WriteLine("Invalid input. Please enter a valid number greater than 0 for time travelled.");
    return;
}

var averageSpeed = distance / timeTravelled;
...
if (!int.TryParse(Console.ReadLine(), out var numberExercise8))
{
...
if (!int.TryParse(Console.ReadLine(), out var sumExercise8))
...
if (!double.TryParse(Console.ReadLine(), out var speed))
{
    Console.WriteLine("Invalid input. Please enter a valid speed in km/h.");
    return;
}

var kmToMetreRate = 3.6;
var speedMtoSeconds = speed * kmToMetreRate;
...
if (!int.TryParse(Console.ReadLine(), out var minutesExercise10) || minutesExercise10 < 0)
{
...
var exerciseType = Console.ReadLine()?.ToLower();
...
var totalCaloriesBurned = caloriesPerMinute * minutes;
